...
def debug_bvm_pull_out():
    ...
    print("set up move")
    motor.simMotorRun([93, 225, 270, 50, 278], [0, 1, 2, 3, 4])  # Reset claw looking up
    time.sleep(2)
...
def debug_bvm_push_in():
    #Push In Battery
    start_time = time.time()
    motor.dxlSetVelo([30, 30, 30, 30, 30, 30], [0, 1, 2, 3, 4])  # ALWAYS SET SPEED BEFORE ANYTHING
    time.sleep(0.1)
    motor.simMotorRun([223],[1])
    time.sleep(.1)
    print("move back to chamber")
    motor.simMotorRun([30,100,180,150],[0,2,3,4])
    time.sleep(10)
    ...
    # time.sleep(0.5)
    # #[225, 160, 78, 266]
    # gcs_push_in_angle = calculation.angle_Calc([250,-6,70], 0)
    # print(gcs_push_in_angle)
    # print("push in to chamber")
    # motor.simMotorRun(gcs_push_in_angle, [1, 2, 3, 4])
    # time.sleep(0.5)
    ...
    # #[225, 116, 191, 196]
    # gcs_push_in_angle = calculation.angle_Calc([370,-6,80], 0)
    # print(gcs_push_in_angle)
    # print("push in to chamber")
    # motor.simMotorRun(gcs_push_in_angle, [1, 2, 3, 4])
    # time.sleep(0.5)
    # motor.simMotorRun([],[2,3])
    # gcs_push_in_angle = calculation.angle_Calc([375,-6,70], 0)
    # print(gcs_push_in_angle)
    # print("push in to chamber")
    # motor.simMotorRun(gcs_push_in_angle, [1, 2, 3, 4])
    # time.sleep(0.5)
