...
def Pull_low():    
    ...
    Close()                                     # grab battery
    motor.dxlSetVelo([12, 30, 15], [2, 3, 4])   # set pull out velocity
...
def Drone_push():
    ...
    motor.simMotorRun([130, 290, 90],[2, 3, 4])                 # move arm to first position
    motor.dxlSetVelo([30, 50, 30, 30, 30], [0, 1, 2, 3, 4])     # set final velocity
