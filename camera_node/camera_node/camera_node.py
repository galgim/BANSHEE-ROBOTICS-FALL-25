...
class CameraNode(Node):
    def __init__(self):
        ...
        thread = threading.Thread(target=asyncio.run(self.cameraRun()))
        thread.start()
    ...
    #     loop.run_until_complete(self.cameraRun())
    ...
    async def cameraRun(self):
        uri = "wss://rgs.bansheeuav.tech/ws"  # WebSocket server
