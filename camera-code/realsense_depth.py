...
class DepthCamera:
    ...
    def __init__(self):
        ...
        config.enable_stream(rs.stream.infrared, 1, self.INFRARED_WIDTH, self.INFRARED_HEIGHT, rs.format.y8, 60)
        config.enable_stream(rs.stream.infrared, 2, self.INFRARED_WIDTH, self.INFRARED_HEIGHT, rs.format.y8, 60)
